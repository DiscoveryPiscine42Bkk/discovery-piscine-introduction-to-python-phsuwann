...
def display_menu():
    print("\n=== ระบบเช็คและจัดการสต็อกผักในฟาร์ม ===")
    print("1. เพิ่มผักเข้าสต็อก")
    print("2. แสดงรายการผักในสต็อก")
    print("3. เบิกผักออกจากสต็อก")
...
def main():
    ...
    while True:
        ...
        if choice == "1":
            ...
            name = input("ชื่อผักที่ต้องการเบิก: ")
            try:
            ...
            print(" ขอบคุณที่ใช้ระบบสต็อกผักในฟาร์ม")
            break
        else:
